...
Public Class crptPrescription
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ECE_MD_Clinic_APP.crptPrescription.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptPrescription
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptPrescription = New crptPrescription()
        rpt.Site = Me.Site
        Return rpt
    End Function
